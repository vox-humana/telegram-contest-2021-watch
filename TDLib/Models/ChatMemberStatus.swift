...
internal enum ChatMemberStatus: Codable {
    ...
    internal func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case let .chatMemberStatusCreator(value):
            try container.encode(Kind.chatMemberStatusCreator, forKey: .type)
            try value.encode(to: encoder)
        case let .chatMemberStatusAdministrator(value):
        ...
        case let .chatMemberStatusRestricted(value):
        ...
        case let .chatMemberStatusBanned(value):
...
/// The user is the owner of a chat and has all the administrator privileges
internal struct ChatMemberStatusCreator: Codable {
...
/// The user is a member of a chat and has some additional privileges. In basic groups, administrators can edit and delete messages sent by others, add new members, ban unprivileged members, and manage voice chats. In supergroups and channels, there are more detailed options for administrator privileges
internal struct ChatMemberStatusAdministrator: Codable {
    ...
    internal let canDeleteMessages: Bool

    /// True, if the administrator can edit messages of other users and pin messages; applicable to channels only
    internal let canEditMessages: Bool
    ...
    internal let canManageChat: Bool

    /// True, if the administrator can manage voice chats
    internal let canManageVoiceChats: Bool

    /// True, if the administrator can pin messages; applicable to basic groups and supergroups only
    internal let canPinMessages: Bool

    /// True, if the administrator can create channel posts; applicable to channels only
    internal let canPostMessages: Bool

    /// True, if the administrator can add new administrators with a subset of their own privileges or demote administrators that were directly or indirectly promoted by them
    internal let canPromoteMembers: Bool

    /// True, if the administrator can restrict, ban, or unban chat members
    internal let canRestrictMembers: Bool
...
/// The user is under certain restrictions in the chat. Not supported in basic groups and channels
internal struct ChatMemberStatusRestricted: Codable {
    /// True, if the user is a member of the chat
    internal let isMember: Bool
    ...
    internal let restrictedUntilDate: Int
...
/// The user or the chat was banned (and hence is not a member of the chat). Implies the user can't return to the chat, view messages, or be used as a participant identifier to join a voice chat of the chat
internal struct ChatMemberStatusBanned: Codable {
    /// Point in time (Unix timestamp) when the user will be unbanned; 0 if never. If the user is banned for more than 366 days or for less than 30 seconds from the current time, the user is considered to be banned forever. Always 0 in basic groups
    internal let bannedUntilDate: Int

    internal init(bannedUntilDate: Int) {
